...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel4.setLayout(new FormLayout("fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow,left:4dlu:noGrow,fill:max(d;4px):noGrow", "center:d:grow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        ...
        panel4.add(homepage, cc.xy(3, 11, CellConstraints.FILL, CellConstraints.DEFAULT));
        verifyButton = new JButton();
        verifyButton.setText("Verify");
        panel4.add(verifyButton, cc.xy(5, 11));
        final JLabel label11 = new JLabel();
        label11.setText("Repository");
        panel4.add(label11, cc.xy(1, 13));
        repositoryUrl = new JTextField();
        panel4.add(repositoryUrl, cc.xy(3, 13, CellConstraints.FILL, CellConstraints.DEFAULT));
        final JLabel label12 = new JLabel();
        label12.setText("Directory:");
        panel4.add(label12, cc.xy(3, 15));
        repositoryDirectory = new JTextField();
        panel4.add(repositoryDirectory, cc.xy(3, 17, CellConstraints.FILL, CellConstraints.DEFAULT));
